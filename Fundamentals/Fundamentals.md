...
Loops can be broken out of with `break`, as well as made to skip the current iteration with `continue`. Loops can also be labeled to break out of multiple nested loops at once:
